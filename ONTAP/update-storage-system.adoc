...
+
Se muestra la lista de clusters que requieren una actualización de software.

. Identifica la versión de destino de ONTAP para tu sistema de almacenamiento.
+
Para información sobre cómo identificar la versión de destino de ONTAP, consulta link:../ONTAP/choose-ontap-910-later.html["Compare las versiones de ONTAP para comprender los beneficios y riesgos de usar actualizaciones de software"].

. Soluciona y reconoce los bloqueos de ONTAP.
+
Para información sobre cómo solucionar bloqueadores, consulta link:../ONTAP/fix-blockers-warnings.html["Corrija todos los bloqueadores mediante actualizaciones de software antes de una actualización de ONTAP"].
